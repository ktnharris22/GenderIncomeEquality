...
ggpairs(nlsy[,c(batch.two.var.names)], axisLabels = "internal", cardinality_threshold = 20)

ggpairs(nlsy[,c(batch.one.var.names)], axisLabels = "internal", cardinality_threshold = 20)
